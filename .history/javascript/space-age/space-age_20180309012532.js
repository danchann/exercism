...
SpaceAge.prototype.onJupiter = function() {
    return ((this.value / 31557600).toFixed(2)/11.862615);
}
SpaceAge.prototype.onSaturn = function() {
    return Number((this.value / 31557600).toFixed(2)/29.447498);
}
SpaceAge.prototype.onUranus = function() {
    return Number((this.value / 31557600).toFixed(2)/84.016846);
}
SpaceAge.prototype.onNeptune = function() {
    return Number((this.value / 31557600).toFixed(2)/164.79132);
}
